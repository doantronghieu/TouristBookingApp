...
})({"h2O9M":[function(require,module,exports) {
...
if (loginForm) loginForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    (0, _login.login)(document.getElementById("email").value, document.getElementById("password").value);
});
...
},{"@babel/polyfill":"dTCHC","./login":"7yHem","./leaflet":"xvuTT","./updateSettings":"l3cGY","./paypal":"jgbWe"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
const updateSettings = async (data, type)=>{
    ...
    try {
        ...
        const url = type === "password" ? `${baseUrl}/${userApiUrl}/updateMyPassword` : `${baseUrl}/${userApiUrl}/updateMe`;
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
            url,
            data
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jgbWe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const bookTour = async (tourId)=>{
    try {
        ...
        const res = await (0, _axiosDefault.default)(`http://127.0.0.1:3000/api/v1/bookings/checkout-session/${tourId}`);
        console.log(res);
        if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", `Tour booked successfully.`);
            window.setTimeout(()=>{
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["h2O9M","f2QDv"], "f2QDv", "parcelRequire11c7")
